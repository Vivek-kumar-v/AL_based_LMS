            ...
            <span
              ...
              style={
                isWord
                  ? {
                      background:
                        "linear-gradient(120deg,#a78bfa 0%,#60a5fa 100%)",
                      borderRadius: "4px",
                      padding: "1px 3px",
                      color: "#fff",
                      fontWeight: 700,
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex gap-3 items-center flex-wrap">
        ...
        {isProcessed && (
          <button
            onClick={() => navigate(`/ask/${doc._id}`, {
              state: {
                title: doc.title,
              },
            })}
            className="px-4 py-2 rounded-2xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition shadow-sm"
          >
            🤖 Ask AI
          </button>
        )}
            ...
            <div className="rounded-3xl border border-gray-200 bg-gradient-to-br from-gray-50 to-white p-4">
              ...
              {ttsSupported && (
                <div className="flex items-center gap-2 flex-wrap mb-3">
                  <button onClick={handleSpeak} className={playBtnClass}>
                    {playBtnLabel}
                  </button>
                  <AnimatePresence>
                    {(isSpeaking || isPaused) && (
                  ...
                  <span
                    className={`text-xs font-bold px-3 py-1.5 rounded-full border ${
                      COLOR[activePreset.color].badge
                    }`}
                  >
              ...
              <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden">
                ...
                <div className="flex border-b border-gray-100">
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 text-xs font-bold transition ${
                      showReadAlong
                        ? "bg-white text-gray-800 border-b-2 border-violet-500"
                        : "bg-gray-50 text-gray-400 hover:text-gray-600"
                    }`}
                  >
                    ✨ Read-Along
